...
hexo.extend.filter.register('after_generate', function () {
    if (hexo.config.electric_clock.enable) {
        ...
        var css_text = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Zfour/hexo-electric-clock@1.0.2/clock.css">`;
        var js_text = `<script src="https://pv.sohu.com/cityjson?ie=utf-8"></script><script data-pjax  src="https://cdn.jsdelivr.net/gh/Zfour/hexo-electric-clock@1.0.2/clock.js"></script>`
